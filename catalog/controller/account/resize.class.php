...
class ImageResize {
	...
	function __construct() {	
			//set local vars
			$this->generate_image_file = false;
			$this->generate_thumbnails = true;
			$this->image_max_size = 500;
			$this->thumbnail_size = 200;
			$this->thumbnail_prefix = "thumb_";
			$this->destination_dir = "system/";
			$this->thumbnail_destination_dir = "system/";
			$this->random_file_name = true;
			$this->quality = 90;
			$this->file_data = $_FILES["avatar"];
