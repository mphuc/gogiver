        ...
        <div class="row">
            ...
            <div class="block_panel text-center">
                ...
                <div class="panel-body p0">
                    ...
                    <p class="text-center s20">Status: Change from ACTIVE to <?php echo ($wallet['block_id']['total_block'] == 1) ? "FROZEN" : "LOCK"; ?></p>
                    ...
                    <div class="col-md-6 col-md-offset-3 mb10">
                        <div class="btn-group btn-group-vertical">
                          <div class="controls">
                             <form id="frmunlockGD" method="GET" action="<?php echo $self->url->link('account/block/unlock_pd_month', '', 'SSL'); ?>">
