...
<div class="panel panel-default" id="dash_0">
   ...
   <div class="panel-heading">
      <h4 class="panel-title"><i class="fa fa-align-justify"></i>Regulation</h4>
   </div>
         ...
         <div class="col-lg-12 col-md-12">
            <div class="input-group input-icon file-upload">
               <div class="widget-content" style="padding:10px">
                  ...
                  ?>
                    <?php for ($i=1;$i<4;$i++) { ?>
                       <img style="margin-top: 10px;" class="img-responsive" src="catalog/view/theme/default/images/qc/000<?php echo $i;?>.jpg" src="" alt="">
                     <?php  }?>
                    <?php } else { ?>
