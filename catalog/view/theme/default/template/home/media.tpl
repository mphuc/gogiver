<?php echo $self->load->controller('home/page/header'); ?>
         ...
         <div id="content" class="site-content">
            ...
            <div class="container">
               ...
               <div class="text-center col-md-3 pull-left" style="text-align: center;">
                  <img class="img-responsive" style="margin-top: 10px; height: 440px !important; width: 300px; margin: 0 auto" src="catalog/view/theme/default/images/e2d17db34d15a74bfe04.jpg" src="" alt="">
               </div>
               <!-- viet -->
