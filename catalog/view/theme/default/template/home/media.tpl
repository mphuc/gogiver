<?php echo $self->load->controller('home/page/header'); ?>
         ...
         <div id="content" class="site-content">
            ...
            <div class="container" style="color: #fff">
               ...
               <!-- viet -->
               <img class="img-responsive" style="margin-top: 10px; height: 100% !important; width: 100%" class="lazy" src="catalog/view/theme/default/images/thitruongvn/19001e3356b4bceae5a5-min.jpg" src="" alt="">
                <img class="img-responsive" style="margin-top: 10px; height: 100% !important; width: 100%" class="lazy" src="catalog/view/theme/default/images/thitruongvn/e4361b045383b9dde092-min.jpg" src="" alt="">
               <?php for ($i=1;$i<34;$i++) { if ($i != 4) { ?>
                 <img class="img-responsive" style="margin-top: 10px; height: 100% !important; width: 100%" class="lazy" src="catalog/view/theme/default/images/thitruongvn/PHAT TRIEN 6 TINH MIEN TAY-<?php echo $i;?>-min.jpg" src="" alt="">
