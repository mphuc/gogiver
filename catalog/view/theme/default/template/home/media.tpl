<?php echo $self->load->controller('home/page/header'); ?>
         ...
         <div id="content" class="site-content">
            ...
            <div class="container">
               ...
               <p style="text-indent: 20px; font-size: 26px;">Gửi các thành viên Iontach thân mến !!!</p>
               ...
               <div class="text-center col-md-12 pull-left" style="text-align: center;">
                  <img class="img-responsive" style="margin-top: 10px; height: 440px !important; width: 300px; margin: 0 auto" src="catalog/view/theme/default/images/18f437420ee4e4babdf5.jpg" src="" alt="">
               </div>
               <!-- viet -->
