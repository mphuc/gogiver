...
<div class="container-fluid">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
        <form action="index.php?route=pd/sendmail_customer/submit&token=<?php echo $_GET['token']; ?>" method="post">
          <input type="hidden" name="customer_id" value="<?php echo $_GET['customer_id']; ?>">
          <div class="form-group">
            <label for="email">Title:</label>
            <input type="text" name="title" class="form-control" id="email" required="true">
          </div>
          <div class="form-group">
