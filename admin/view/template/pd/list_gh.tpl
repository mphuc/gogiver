  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <ul class="nav nav-tabs">
          <li class="active"><a data-toggle="tab" href="#home">Toàn bộ GD</a></li>
        ...
        <?php echo $pagination ?>
          ...
          <div id="menu1" class="tab-pane fade">
            ...
            <tbody id="result_date"> 
                <?php $stt = 0;
                foreach ($get_all_gd_lock as $values) { $stt ++?>
                  <tr>
                    <td><?php echo $stt; ?></td>
                    <!-- <td><?php echo $value['customer_id'] ?></td> -->
                    <td><?php echo $values['username'] ?></td>
                    <td><?php echo $values['account_holder'] ?></td>
                    <td><?php echo number_format($values['amount']) ?> VNĐ</td>
                    <td><?php 
          ...
          <div id="menu2" class="tab-pane fade" style="width: 115%">
            ...
            <tbody id="result_date"> 
                <?php $stt = 0;
                $total_gd = 0;
                foreach ($getGD7Before as $valuess) { $stt ++;
                    $total_gd += $valuess['amount'];
                ?>
                  <tr>
                    <td><?php echo $stt; ?></td>
                    <!-- <td><?php echo $value['customer_id'] ?></td> -->
