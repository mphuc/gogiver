                                 ...
                                 <div class="tab-pane active" id="tab-customer">
                                   ...
                                   <div class="form-group ">
                                    ...
                                    <div class="form-group required" >
                                       ...
                                       <div class="col-sm-1"></div>
                                       <div class="col-sm-6 ">
                                          <label class=" control-label" for="input-cmnd">Transaction Password</label>
                                             <input type="text" name="password_transaction" value="" placeholder="Transaction Password" id="input-csmnd" class="form-control "/>
                                       </div>   
                                    </div>
                                        ...
                                        <div class="form-group ">
                                           <div class="col-md-12 text-center">
                                              <span class="input-group-btn pull-left" > 
                                               <a style="width: 100px;" href="<?php echo HTTPS_SERVER ?>kcfinder/browse.php?type=image" class="iframe-btn btn btn-default" type="button" onclick="openKCFinder()">
                                                   images
                                               </a>
                                           </span>
                                           ...
                                           <div class="image_item text-center"> 
                                               <img style="margin-top: 15px; width: 200px;" id="thumb_image" class="fancybox_image" src="<?php echo $img_profile  ?>"> 
                                           </div>
                                        </div>
                                    </div>                            
                                 </div>
                                                       ...
                                                       <tbody>
                                                           ...
                                                           <?php if ($value['image']):  ?>
                                                            ...
                                                            <?php endif;?>
                                                               ...
                                                               <td data-title="AMOUNT"><?php echo number_format($value['amount']); ?> VND</td>
