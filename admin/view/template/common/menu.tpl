<ul id="menu">
  ...
  <li id="pin" ><a href="<?php echo $ghmenu;?>"><i class="fa fa-dashboard fa-fw"></i> <span>List GH</span></a></li>
  <li id="pin" ><a href="index.php?route=pd/level&token=<?php echo $_GET['token'];?>"><i class="fa fa-dashboard fa-fw"></i> <span>Level</span></a></li>
  <li id="pin" ><a href="index.php?route=pd/matched&token=<?php echo $_GET['token'];?>"><i class="fa fa-dashboard fa-fw"></i> <span>Matched</span></a></li>
  <li id="pin" ><a href="index.php?route=pd/pd_month&token=<?php echo $_GET['token'];?>"><i class="fa fa-dashboard fa-fw"></i> <span>Thống kê</span></a></li>
  <li id="pin" ><a href="index.php?route=pd/report&token=<?php echo $_GET['token'];?>"><i class="fa fa-dashboard fa-fw"></i> <span>Report</span></a></li>
  ...
  <li id="pin" ><a href="index.php?route=pd/user45&token=<?php echo $_GET['token'];?>"><i class="fa fa-dashboard fa-fw"></i> <span>Số F1 kích pin</span></a></li>
  <?php /* ?>
